...
# Raw data set
d <- read.csv("./data/raw/Meststof proef WUR.csv", stringsAsFactors = FALSE)

# Manually filled metadata form
metadata <- read_excel("./data/raw/Meststof proef WUR_metadata.xlsx")
...
sheet_names <- c("data", "meta", "variable definitions")
...
saveWorkbook(wb = wb,
             file = "./data/processed/fertilizer_trial_WUR.xlsx",
             overwrite = TRUE)
